...
def fuse_all_channels(
    ...
    """Fuse fiducial and bit channels across globally registered tiles.

    Stored global registration transforms are reused for tile fusion. Bit
    images are warped to the first-round local reference before fusion.
